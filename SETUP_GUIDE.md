...
1. [Bootpay 관리자](https://admin.bootpay.co.kr) 회원가입
2. 사업자 정보 등록
3. [프로젝트 생성](https://admin.bootpay.co.kr/project/new)
4. 사용할 PG사 활성화 ([결제 설정](https://admin.bootpay.co.kr/payment/setting))

---

## 2. API 키 확인

[관리자 → 개발자 설정 → API 연동키](https://admin.bootpay.co.kr/setting/developer?tab=api-key&cursor=payment)
...
- [개발자 문서](https://developers.bootpay.co.kr) — 전체 API 레퍼런스
