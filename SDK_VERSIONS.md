...
| Android | `io.github.bootpay:android` | 5.2.0 | `implementation 'io.github.bootpay:android:5.2.0'` |
| iOS (Swift) | `Bootpay` | 5.2.0 | `pod 'Bootpay', '~> 5.2.0'` |
| iOS (SwiftUI) | `BootpayUI` | 4.6.0 | `pod 'BootpayUI', '~> 4.6.0'` |
| Flutter | `bootpay` | 5.2.0 | `flutter pub add bootpay` |
...
| Java | `io.github.bootpay:backend` | 3.1.0 | `implementation 'io.github.bootpay:backend:3.1.0'` |
...
| PHP | `bootpay/server-php` | 2.3.0 | `composer require bootpay/server-php` |
